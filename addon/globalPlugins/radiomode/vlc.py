...
__version__ = "3.0.4106"
__libvlc_version__ = "3.0.4"
__generator_version__ = "1.6"
build_date  = "Sun Oct  7 00:09:54 2018 3.0.4"
    ...
    if sys.platform.startswith('linux'):
        ...
        if p is None:
            ...
            if plugin_path is None:
                ...
                for p in ('{programfiles}\\VideoLan{libname}', '{programfiles64}\\VideoLan{libname}', '{homedir}:\\VideoLan{libname}',
